...
## Other
So many interesting areas to explore, yet I have to make choices.
...
* Get up to speed with Android O [notification channels](https://developer.android.com/preview/features/notification-channels.html)
