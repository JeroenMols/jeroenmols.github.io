...
---
As my previous blogposts covered already covered in depth how to set up a private Maven repository, you might wonder "Why again a Maven blogpost?". Well that's a very fair question because Artifcatory was already free and ridiculously easy to set up.

However, to use it in a corporate environment, Artifactory still requires you to solve two main problems yourself:

1. Provide a backup mechanism, to ensure you never ever loose releases.
2. Allow remote access to Artifactory so devs don't need to be connected to the intranet to build projects.

Arguiable, both problems shouldn't pose a major challenge in this day and age. But as they still require effort/cost to set up, my DIY self challenged me to come up with an easy solution to both of these problems.
